...
function preload(){
  ...
  this.load.spritesheet('jump', "/Knight/Meow-Knight_Jump.png", {frameWidth: 16, frameHeight: 16})

  this.load.spritesheet('attack1', "/Knight/Meow-Knight_Attack_1.png", {frameWidth: 16, frameHeight: 16})
  this.load.spritesheet('attack2', "/Knight/Meow-Knight_Attack_2.png", {frameWidth: 16, frameHeight: 16})
  this.load.spritesheet('attack3', "/Knight/Meow-Knight_Attack_3.png", {frameWidth: 16, frameHeight: 16})
  this.load.spritesheet('attack4', "/Knight/Meow-Knight_Attack_4.png", {frameWidth: 16, frameHeight: 16})
  
  this.load.spritesheet('death', "Knight/Meow-Knight_Death.png", {frameWidth: 16, frameHeight: 16})
  this.load.spritesheet('dodge', "Knight/Meow-Knight_Dodge.png", {frameWidth: 16, frameHeight: 16})
  this.load.spritesheet('damage', "Knight/Meow-Knight_Take_Damage.png", {frameWidth: 16, frameHeight: 16})
